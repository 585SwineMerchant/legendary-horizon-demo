export type QuestOfFateProphecy = {
  prophecy_id: number;
  title: string;
  /** Oracle of Fate (CareerOneStop) */
  oracle_url: string;
  /** Vault of Runes (BLS OOH) */
  research_url: string;
};

// Source: `Project Documents/Oracle of Fate.md` + `Project Documents/Vault of Runes.md`
// Note: ids are 1..41 inclusive.
export const QUEST_OF_FATE_PROPHECIES: QuestOfFateProphecy[] = [
  {
    prophecy_id: 1,
...
export function getQuestOfFateProphecy(id: number): QuestOfFateProphecy | undefined {
  return QUEST_OF_FATE_PROPHECIES.find((p) => p.prophecy_id === id);
}
